    ...
    <div className="shadow border rounded-lg">
      ...
      <div className="flex flex-col gap-2 border-t border-gray-300 bg-gray-100 p-4">
        ...
        <div className="flex gap-8 text-xs">
          <button
            className="bg-gray-800 hover:bg-gray-900 text-white py-1 px-3 rounded-full"
            onClick={() => animationStart(title)}
          >
            Start
          </button>
          <button
            className="bg-gray-100 hover:bg-gray-200 text-gray-800 py-1 px-3 rounded-full border border-gray-400"
